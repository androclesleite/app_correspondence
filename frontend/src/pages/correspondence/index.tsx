...
export function PackagesList() {
  const { user } = useAuth()
  const { canCreatePackages, canDeletePackages, canManagePackages, canViewAllStores } = usePermissions()
    ...
    try {
      const [packagesData, storesData] = await Promise.all([
        packagesApi.list({
          ...
          store_id: storeFilter === 'all' || !storeFilter ? undefined : parseInt(storeFilter)
        }),
        storesApi.list(),
      ])
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between p-6 pb-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Correspondências</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="collected">Retirada</SelectItem>
